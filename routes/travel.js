...
router.patch('/update-user-review', authenticate, controller.updateUserReview)
router.patch('/update-user-travelReview', authenticate, controller.updateUserTravelReview)
